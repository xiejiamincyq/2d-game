...
func _initialize() -> void:
	...
	if OS.get_cmdline_user_args().has("markers"):
		report_path = REPORT_PATH.replace("-v1", "-markers-v1")
		capture_path = "res://docs/art/previews/environment/mint-farm-stress-markers-v1.png"
